...
const Rope = ({category, collection, product}) => {
  return (
    <div className={styles.rope}>
        ...
        <span><div><IoShareSocialSharp/></div>Share</span><div><Link href={'https://www.instagram.com/two4line?igsh=MmVlMjlkMTBhMg=='} className={styles.footer_icons}><AiOutlineInstagram/></Link></div> <div><AiFillFacebook/> </div> <div><FaXTwitter/></div> <div><BiLogoTiktok/></div>
        </div>
    </div>
  )
}
